...
class Modal(ft.Container):
    ...
    def _build(self):
        ...
        modal_container = ft.Container(
            ...
            # width=self.modal_width if self.modal_width else None,
            ...
            shadow=ft.BoxShadow(
                spread_radius=1,
                blur_radius=15,
                color=ft.Colors.with_opacity(0.3, "transparent black"),
                offset=ft.Offset(0, 4),
            ),
        )
        
        # Constrain modal size if max dimensions are set
        ...
        backdrop = ft.Container(
            bgcolor=ft.Colors.with_opacity(0.5, "transperant black"),
            expand=True,
